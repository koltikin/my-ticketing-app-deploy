...
public class UserServiceImpl implements UserService {
    ...
    private String host_service_port;
...
//        dto.setEnabled(true);
        ...
        saveUserConfirmation(dto.getUserName());
        sendUserVerificationEmail(dto.getUserName());
        ...
        if (isUserExistByEmail(userName)) {
            ...
            if (!user.isEnabled()) {
                ...
                String message = "Click the link blow to Verify Your Cydeo Ticketing Account.\n\n " +
                        "http://localhost:"+host_service_port+"/user/verify?token=" + token + "\n\n" +
                ...
                String buttonUrl = "http://localhost:"+host_service_port+"/user/verify?token=" + token;
...
//                emailService.sendSimpleMessage(userName,subject,message);
    ...
    public void sendUserPassWordResetLink(String email) {
        ...
        String message = "You recently requested to change your password.\n" +
                ...
                "http://localhost:"+host_service_port+"/user/change-password?token="+token+"\n\n" +
        ...
        String url = "http://localhost:"+host_service_port+"/user/change-password?token="+token;
